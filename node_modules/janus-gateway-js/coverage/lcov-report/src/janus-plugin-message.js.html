...
<html lang="en">
<head>
    <title>Code coverage report for src/janus-plugin-message.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> janus-plugin-message.js
    </h1>
    <div class='clearfix'>
 ...
 * @returns {string}
 */
JanusPluginMessage.prototype.getResultText = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  return this.getPluginData(this._plugin.getResponseAlias());</span>
};
&nbsp;
