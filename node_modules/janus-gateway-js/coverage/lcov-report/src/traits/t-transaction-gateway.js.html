...
<html lang="en">
<head>
    <title>Code coverage report for src/traits/t-transaction-gateway.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/traits/</a> t-transaction-gateway.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
  ...
  defaultProcessIncomeMessage: function(incomeMessage) {
    ...
    if (self.hasTransaction(incomeMessage)) {
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (incomeMessage.getError()) {
<span class="cstat-no" title="statement not covered" >        return Promise.reject(new JanusError(incomeMessage));</span>
      }
    }
  }
};
